...
import {Canvas, NAVY, OCKER, STROKE} from './shared';
...
export const Scene02Route: React.FC = () => {
  const frame = useCurrentFrame();
  const {durationInFrames} = useVideoConfig();
  const d = interpolate(frame, [0.08 * durationInFrames, 0.88 * durationInFrames], [0, 100], {
  ...
  return (
    <Canvas>
      <path d={ROUTE} vectorEffect="non-scaling-stroke" fill="none" stroke={NAVY} strokeWidth={STROKE} strokeLinecap="round" strokeDasharray="0.5 16" opacity={0.45} />
      <g transform="translate(72 336) scale(2.9)" fill="none" stroke={NAVY} strokeWidth={STROKE} strokeLinecap="round" strokeLinejoin="round">
      ...
      <g transform="translate(338 74) scale(2.9)" fill="none" stroke={NAVY} strokeWidth={STROKE} strokeLinecap="round" strokeLinejoin="round">
