...
import { BarChartSquare02, Calculator, Clock, Cube01, HomeLine, LayoutAlt01, LifeBuoy01, LineChartUp01, Ruler, Settings01 } from "@untitledui/icons";
...
export const SettingsShell = ({ children }: { children: ReactNode }) => {
    return (
        <div className="flex flex-col bg-primary lg:flex-row">
            <SidebarNavigationSimple activeUrl="/settings" items={navItems} footerItems={footerNavItems} />
