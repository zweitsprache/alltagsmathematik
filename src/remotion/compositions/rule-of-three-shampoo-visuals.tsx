...
const routeIconScale = 2.9;
const routeIconStrokeWidth = outlineWidth / routeIconScale;
const roundedStroke = {
    strokeLinecap: "round" as const,
    strokeLinejoin: "round" as const,
};
const consistentStroke = {
    ...roundedStroke,
        ...
        >
            <g transform="translate(21.6 -19.9) scale(0.91)">
                ...
                <g transform={`rotate(${rotation + shake} 240 240)`}>
                    ...
                    <path d={bottlePath} fill="none" stroke={navy} strokeWidth={outlineWidth} {...consistentStroke} />
                    <rect x="204" y="212" width="72" height="62" rx="10" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...consistentStroke} />
                    <line x1="220" y1="234" x2="260" y2="234" stroke={accent} strokeWidth={outlineWidth} {...consistentStroke} />
                    <line x1="220" y1="252" x2="246" y2="252" stroke={accent} strokeWidth={outlineWidth} {...consistentStroke} />
                    <rect x="214" y="118" width="52" height="30" rx="7" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...consistentStroke} />
                    <path
                        d="M 232 118 V 110 Q 232 106 236 106 H 244 Q 248 106 248 110 V 118"
                        fill="#ffffff"
                        stroke={navy}
                ...
                <g opacity={shakeLinesOpacity}>
                    <path d="M 152 198 Q 138 240 152 282" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
                    <path d="M 128 214 Q 118 240 128 266" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} opacity="0.55" />
                    <path d="M 328 198 Q 342 240 328 282" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
                    <path d="M 352 214 Q 362 240 352 266" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} opacity="0.55" />
                </g>
                ...
                <g transform="translate(240 464)" opacity={splashOpacity}>
                    <path d="M -20 0 Q -26 -8 -24 -14" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
                    <path d="M 20 0 Q 26 -8 24 -14" fill="none" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
...
export const RouteVisual = ({ frame }: { frame: number }) => {
    ...
    const dotX = progress <= 0.78 ? cubicPoint(firstSegmentProgress, 148, 240, 170, 250) : cubicPoint(secondSegmentProgress, 250, 315, 316, 334);
    const dotY = progress <= 0.78 ? cubicPoint(firstSegmentProgress, 344, 316, 215, 192) : cubicPoint(secondSegmentProgress, 192, 174, 172, 150);
    ...
    return (
        ...
        >
            <path
                ...
                opacity="0.4"
            />
            <g transform={`translate(72 336) scale(${routeIconScale})`} fill="none" stroke={navy} strokeWidth={routeIconStrokeWidth} {...roundedStroke}>
                <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" />
            </g>
            <g transform={`translate(338 74) scale(${routeIconScale})`} fill="none" stroke={navy} strokeWidth={routeIconStrokeWidth} {...roundedStroke}>
            ...
            <circle cx={dotX} cy={dotY} r="12" fill={accent} stroke="#ffffff" strokeWidth={outlineWidth} />
        </svg>
    );
};
...
export const SupermarketShelfVisual = ({ frame }: { frame: number }) => {
    ...
    return (
        ...
        >
            ...
            <g opacity={shampoo}>
                <g transform="translate(4.6 77.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
            </g>
            <g opacity={jar}>
                <rect x="145" y="173" width="55" height="50" rx="8" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                <rect x="141" y="157" width="63" height="18" rx="6" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                <line x1="158" y1="199" x2="188" y2="199" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
            </g>
            <g opacity={tube}>
                <path d="M 231 210 L 259 210 L 255 146 L 235 146 Z" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                <rect x="232" y="210" width="26" height="16" rx="3" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                <line x1="242" y1="184" x2="248" y2="184" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
            </g>
            <g opacity={pump}>
                <rect x="288" y="153" width="52" height="70" rx="10" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                ...
                <line x1="302" y1="187" x2="326" y2="187" stroke={accent} strokeWidth={outlineWidth} {...roundedStroke} />
            </g>
            <g opacity={slimBottle}>
                <rect x="362" y="123" width="38" height="100" rx="9" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
                <path d="M 372 121 L 372 106 Q 372 102 376 102 L 386 102 Q 390 102 390 106 L 390 121 Z" fill={navy} />
            </g>

            <g opacity={duo}>
                <g transform="translate(4.6 245.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
                <g transform="translate(57.6 245.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
            </g>
            <g opacity={multipack}>
                <g transform="translate(156.6 245.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
                <g transform="translate(209.6 245.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
                <g transform="translate(262.6 245.1) scale(0.42)">
                    <FullBottle clipId="rule-three-shelf-bottle-clip" />
                </g>
            </g>
        </svg>
...
const PriceTag = ({ y, value, opacity }: { y: number; value: string; opacity: number }) => (
    <g transform={`translate(0 ${y})`} opacity={opacity}>
        <rect x="294" y="-28" width="146" height="56" rx="12" fill="#ffffff" stroke={navy} strokeWidth={outlineWidth} {...roundedStroke} />
        <text
            x="367"
            y="0"
            dy="0.08em"
    ...
    return (
        <svg viewBox="0 0 480 480" aria-hidden="true" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: sceneOpacity }}>
            <g transform="translate(38.8 40.5) scale(0.83)">
                ...
                <g opacity={duo}>
                    <g transform={`translate(-52 ${125 + 8 * (1 - duo)}) scale(0.5)`}>
                        <FullBottle />
                    </g>
                    <g transform={`translate(12 ${125 + 8 * (1 - duo)}) scale(0.5)`}>
                        <FullBottle />
                    </g>
                    <rect x="34" y="241.5" width="134" height="40" rx="8" fill={accent} />
                    <text
                        x="101"
                        y="262.5"
                        textAnchor="middle"
                ...
                <g opacity={action}>
                    <g transform={`translate(-52 ${265 + 8 * (1 - action)}) scale(0.5)`}>
                        <FullBottle />
                    </g>
                    <g transform={`translate(12 ${265 + 8 * (1 - action)}) scale(0.5)`}>
                        <FullBottle />
                    </g>
                    <g transform={`translate(76 ${265 + 8 * (1 - action)}) scale(0.5)`}>
                        <FullBottle />
                    </g>
                    <rect x="34" y="381.5" width="198" height="40" rx="8" fill={accent} />
                    <text
                        x="133"
                        y="402.5"
                        textAnchor="middle"
...
export const QuestionMarkFirework = ({ frame }: { frame: number }) => (
    <svg viewBox="0 0 480 480" aria-hidden="true" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" }}>
