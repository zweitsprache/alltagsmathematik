...
export const FONT = '"Encode Sans Semi Condensed", sans-serif';
...
export const BottleSmall: React.FC<{color?: string}> = ({color = NAVY}) => (
  <g>
    ...
    <path d={BOTTLE_BODY} vectorEffect="non-scaling-stroke" fill="none" stroke={color} strokeWidth={7} strokeLinejoin="round" />
    <path d={BOTTLE_CAP} vectorEffect="non-scaling-stroke" fill="#ffffff" stroke={color} strokeWidth={7} strokeLinejoin="round" />
    <path
...
export const BottleMini: React.FC<{color?: string}> = ({color = NAVY}) => (
  <g>
    <path d={BOTTLE_BODY} vectorEffect="non-scaling-stroke" fill="#ffffff" stroke={color} strokeWidth={7} strokeLinejoin="round" />
    <path d={BOTTLE_CAP} vectorEffect="non-scaling-stroke" fill="#ffffff" stroke={color} strokeWidth={7} strokeLinejoin="round" />
  </g>
);
...
export const PriceTag: React.FC<{price: string}> = ({price}) => (
  <g>
    <rect x={-124} y={-24} width={124} height={48} rx={10} vectorEffect="non-scaling-stroke" fill="none" stroke={NAVY} strokeWidth={7} strokeLinecap="round" strokeLinejoin="round" />
